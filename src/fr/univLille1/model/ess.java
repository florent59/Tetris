...
public class ess extends Forme {
	private static final int COULEUR=02;

		private int pos;
		private pc[] tab;
		
		public ess(GameModel game){
			super.game=game;
			tab=new pc[4];
			tab[0]= new pc(game.getX()/2,0,COULEUR);
			tab[1]= new pc(game.getX()/2,1,COULEUR);
